...
public class ChoucairLoginPage extends PageObject {
    ...
    public static final Target INPUT_USER = Target.the("where we write the user").located(By.id("username"));
    public static final Target INPUT_PASSWORD = Target.the("where we write the password").located(By.id("password"));
    public static final Target ENTER_BUTTON = Target.the("buttom to confirm login").located(By.xpath("//button[contains(@class, 'btn btn-primary')]"));
